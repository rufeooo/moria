...
static char* errtab[7] = {"Unable to move data into handle",
...
static void SumStr(ptr) char** ptr;
...
static void AddStr(ptr) char** ptr;
...
static void NxtString(ptr) char** ptr;
...
long LoadRes(memPtr, resType, resID, elemCnt, elemSiz, strProc) char** memPtr;
long resType;
long resID;
unsigned long elemCnt, elemSiz;
void (*strProc)(char* elem, void (*proc)(char** str));
