...
#endif
        treasureRsrc, object_list_id, MAX_OBJECTS, sizeof(treasure_type),
        treasure_strproc, TRUE},
#endif
#ifndef RSRC_PART1
    {
#ifdef RSRC
...
#endif
        backgroundRsrc, background_id, MAX_BACKGROUND, sizeof(background_type),
        background_strproc, TRUE},
    {
#ifdef RSRC
...
#endif
        spellRsrc, magic_spell_id, (MAX_CLASS - 1) * 31, sizeof(spell_type),
        NULL, TRUE},
    {
#ifdef RSRC
...
#endif
        charPtrRsrc, player_title_id, MAX_CLASS* MAX_PLAYER_LEVEL,
        sizeof(char*), char_ptr_strproc, TRUE},
    {
#ifdef RSRC
        (char*)race, "Race List",
#else
        (char**)&race, NULL,
#endif
        raceRsrc, race_id, MAX_RACES, sizeof(race_type), race_strproc, TRUE},
    {
#ifdef RSRC
        ...
        (char**)&c_list, NULL,
#endif
        monsterRsrc, c_list_id, MAX_CREATURES, sizeof(creature_type),
        creature_strproc, TRUE},
    {
#ifdef RSRC
        ...
        (char**)&owners, NULL,
#endif
        ownerRsrc, owners_id, MAX_OWNERS, sizeof(owner_type), owner_strproc,
        TRUE},
    {
#ifdef RSRC
        (char*)colors, "Colors",
        ...
        (char**)&colors, NULL,
#endif
        charPtrRsrc, colors_id, MAX_COLORS, sizeof(char*), char_ptr_strproc,
        TRUE},
    {
#ifdef RSRC
        ...
        (char**)&mushrooms, NULL,
#endif
        charPtrRsrc, mushrooms_id, MAX_MUSH, sizeof(char*), char_ptr_strproc,
        TRUE},
    {
#ifdef RSRC
        (char*)woods, "Woods",
        ...
        (char**)&woods, NULL,
#endif
        charPtrRsrc, woods_id, MAX_WOODS, sizeof(char*), char_ptr_strproc,
        TRUE},
    {
#ifdef RSRC
        (char*)metals, "Metals",
        ...
        (char**)&metals, NULL,
#endif
        charPtrRsrc, metals_id, MAX_METALS, sizeof(char*), char_ptr_strproc,
        TRUE},
    {
#ifdef RSRC
        (char*)rocks, "Rocks",
        ...
        (char**)&rocks, NULL,
#endif
        charPtrRsrc, rocks_id, MAX_ROCKS, sizeof(char*), char_ptr_strproc,
        TRUE},
    {
#ifdef RSRC
        ...
        (char**)&amulets, NULL,
#endif
        charPtrRsrc, amulets_id, MAX_AMULETS, sizeof(char*), char_ptr_strproc,
        TRUE},
    {
#ifdef RSRC
        ...
        (char**)&syllables, NULL,
#endif
        charPtrRsrc, syllables_id, MAX_SYLLABLES, sizeof(char*),
        char_ptr_strproc, TRUE}
#endif
};

#ifdef MACGAME
memtable_type memtable[MAX_PTRS] = {
    {(char**)&cave, MAX_HEIGHT* MAX_WIDTH, sizeof(cave_type), TRUE},
    {(char**)&store, MAX_STORES, sizeof(store_type), TRUE},
    {(char**)&c_recall, MAX_CREATURES, sizeof(recall_type), TRUE},
};
#endif
...
void treasure_strproc(ptr, proc) char* ptr;
void (*proc)(char** str);
...
void creature_strproc(ptr, proc) char* ptr;
void (*proc)(char** str);
...
void race_strproc(ptr, proc) char* ptr;
void (*proc)(char** str);
...
void background_strproc(ptr, proc) char* ptr;
void (*proc)(char** str);
...
void owner_strproc(ptr, proc) char* ptr;
void (*proc)(char** str);
...
void char_ptr_strproc(ptr, proc) char* ptr;
void (*proc)(char** str);
