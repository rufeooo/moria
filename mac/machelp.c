...
static void DoHScroll(where, part) Point where;
short part;
...
static pascal Boolean MacHelpFilter(theDialog, theEvent,
...
static pascal void DrawTextBox(theWindow, theItem) WindowPtr theWindow;
short theItem;
