...
print_damage(attstr) int8u attstr[4];
{
  ...
  for (count = 0; count < 4; count++) {
    ...
    switch (attype) {
      ...
      case 2:
        ...
        break;
      case 3:
        printf("%s(Conf) ", damstr);
        break;
      case 4:
        printf("%s(Fear) ", damstr);
        break;
      case 5:
        printf("%s(Fire) ", damstr);
        break;
      case 6:
        printf("%s(Acid) ", damstr);
        break;
      case 7:
        printf("%s(Cold) ", damstr);
        break;
      case 8:
        printf("%s(Zap) ", damstr);
        break;
      case 9:
        ...
        break;
      case 10:
        printf("%s(Blind) ", damstr);
        break;
      case 11:
        printf("%s(Paral) ", damstr);
        break;
      case 12:
        printf("%s(-Money) ", damstr);
        break;
      case 13:
        printf("%s(-Object) ", damstr);
        break;
      case 14:
        printf("%s(Poison) ", damstr);
        break;
      case 15:
        printf("%s(-Dex) ", damstr);
        break;
      ...
      case 19:
        ...
        break;
      case 20:
        printf("%s(Aggr) ", damstr);
        break;
      case 21:
        printf("%s(-Magic) ", damstr);
        break;
      case 22:
        printf("%s(-Food) ", damstr);
        break;
      case 23:
        printf("%s(-Light) ", damstr);
        break;
      case 24:
        printf("%s(-Charges) ", damstr);
        break;
      default:
      case 99:
        printf("%s(Blank) ", damstr);
        break;
    }
  }
}

print_flags_spells(spells) unsigned long spells;
{
  int count;
  unsigned long mask;
  int chance;
  ...
  for (count = 4, mask = 0x010; count < 32; mask <<= 1, count++) {
    switch (spells & mask) {
      ...
      case CS_FEAR:
        ...
        break;
      case CS_SUMMON_MON:
        printf("CS_SUMMON_MON ");
        break;
      case CS_SUMMON_UND:
        printf("CS_SUMMON_UND ");
        break;
      case CS_SLOW_PER:
        printf("CS_SLOW_PER ");
        break;
      case CS_DRAIN_MANA:
        printf("CS_DRAIN_MANA ");
        break;
      case CS_BR_LIGHT:
        printf("CS_BR_LIGHT ");
        break;
...
print_flags_cmove(cmove) unsigned long cmove;
{
  int count;
  unsigned long mask;
  ...
  for (count = 0, mask = 0x01; count < 32; mask <<= 1, count++) {
    switch (cmove & mask) {
      case CM_ATTACK_ONLY:
        printf("CM_ATTACK_ONLY ");
        break;
      case CM_MOVE_NORMAL: /*printf("CM_MOVE_NORMAL ");*/
        break;
      case CM_20_RANDOM:
        printf("CM_20_RANDOM ");
        break;
      ...
      case CM_MULTIPLY:
        ...
        break;
      case CM_CARRY_OBJ:
        printf("CM_CARRY_OTHER ");
        break;
      case CM_CARRY_GOLD:
        printf("CM_CARRY_GOLD ");
        break;
      case CM_60_RANDOM:
        printf("CM_60_RANDOM ");
        break;
...
print_flags_cdefense(cdefense) unsigned int cdefense;
{
  int count;
  unsigned int mask;

  if (cdefense == 0) return;
