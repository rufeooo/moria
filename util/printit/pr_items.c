...
print_flags(tval, flags) char tval;
unsigned long flags;
{
  int count;
  unsigned long mask;
  ...
  if (tval == 80) {
    ...
    for (count = 0, mask = 0x01; count < 32; mask <<= 1, count++) {
      switch (flags & mask) {
        case 0x00000001:
          printf("poison(lvl+rnd(10)) ");
          break;
        case 0x00000002:
          printf("blind(10*lvl+rnd(250)+100) ");
          break;
        case 0x00000004:
          printf("fear(lvl+rnd(10) ");
          break;
        case 0x00000008:
          printf("confused(lvl+rnd(10) ");
          break;
        case 0x00000010:
          printf("hallucinate(25*lvl+rnd(200)+200) ");
          break;
        case 0x00000020:
          printf("cure_poison ");
          break;
        case 0x00000040:
          printf("cure_blindness ");
          break;
        case 0x00000080:
          printf("cure_fear ");
          break;
    ...
    printf(">");
  } else if (tval >= TV_MIN_WEAR && tval <= TV_MAX_WEAR) {
    printf("<");
    for (count = 0, mask = 0x01; count < 32; mask <<= 1, count++) {
      switch (flags & mask) {
        case TR_STR:
        ...
        case TR_FREE_ACT:
          ...
          break;
        case TR_SEE_INVIS:
          printf("See_Invisible ");
          break;
        case TR_RES_LIGHT:
          printf("Resist_Lightning ");
          break;
        case TR_FFALL:
          printf("Feather_Fall ");
          break;
